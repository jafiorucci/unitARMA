...
#' BARMA Model
#'
#' Fit and forecast the Beta Autoregressive and Moving Average (BARMA) model as
#' an extension of the Beta regression for the case of autocorrelated residuals.
...
#' @export
BARMA<- function(y, ar=NA, ma=NA, link = "logit", h=6, X=NA, X_hat=NA, resid=3)
{
  #source("barma.fit.r")
  ...
  fit1 <- barma.fit(y=y, ar=ar, ma=ma, link=link1, names_phi=names_phi,
                    names_theta=names_theta, names_beta=names_beta, diag=0,
                    h1=h, X=X, X_hat=X_hat,resid=resid) # model estimation
